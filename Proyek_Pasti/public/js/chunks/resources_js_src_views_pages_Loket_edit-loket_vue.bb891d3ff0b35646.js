...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_7___default().get("http://localhost:8085/lokets/" + id, {
      headers: {
    ...
    axios__WEBPACK_IMPORTED_MODULE_7___default().get("http://localhost:8081/admin-lokets", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
