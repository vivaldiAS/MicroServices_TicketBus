...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post("http://localhost:8081/login", data).then(function (response) {
        if (response.data.message === "Login berhasil") {
          ...
          var userRoleID = response.data.userRoleID; // Ambil userRoleID dari respons server

          localStorage.setItem("access_token", token);
          localStorage.setItem("userRoleID", userRoleID); // Simpan userRoleID di localStorage
  ...
  mounted: function mounted() {
    ...
    var userRoleID = localStorage.getItem("userRoleID"); // Ambil userRoleID dari localStorage
  }
});
