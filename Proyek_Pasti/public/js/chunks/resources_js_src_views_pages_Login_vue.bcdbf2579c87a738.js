...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    var isPasswordVisible = (0,vue__WEBPACK_IMPORTED_MODULE_3__.ref)(false);
    var email = (0,vue__WEBPACK_IMPORTED_MODULE_3__.ref)("");
    var password = (0,vue__WEBPACK_IMPORTED_MODULE_3__.ref)("");
    var rememberMe = (0,vue__WEBPACK_IMPORTED_MODULE_3__.ref)(false);
    return {
  ...
  methods: {
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post("http://localhost:8081/login", data).then(function (response) {
        // Jika respons adalah "Login berhasil", arahkan pengguna ke halaman dashboard
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
          icon: "error",
          title: "Login gagal",
          text: "Terjadi kesalahan saat melakukan login. Silakan coba lagi nanti.",
          confirmButtonText: "Ok",
          confirmButtonColor: "#d33"
        });
      })["finally"](function () {
