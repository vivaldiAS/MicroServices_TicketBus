...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    editProfile: function editProfile() {
      this.editedUser = (0,E_1PROYEK_PASTI_Proyek_Pasti_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, this.user);
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default().get("http://localhost:8081/profile", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      },
      params: {
