...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var password = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__.ref)("");
    var rememberMe = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__.ref)(false);
    return {
  ...
  methods: (0,E_1PROYEK_PASTI_Proyek_Pasti_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_1PROYEK_PASTI_Proyek_Pasti_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapActions)(['setUserRole'])), {}, {
    // Menggunakan setUserRole dari Vuex actions
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().post("http://localhost:8081/login", data).then(function (response) {
        if (response.data.message === "Login berhasil") {
          var token = response.data.access_token;
          localStorage.setItem("access_token", token);
          localStorage.setItem("expires_at", response.data.expires_at);
          var email = localStorage.getItem('email'); // Menampilkan email pada console log

          console.log("Role ID:", response.data.role_id); // Simpan email ke dalam localStorage

          localStorage.setItem('userEmail', response.data.email); // Simpan role di Vuex

          _this.$store.dispatch('setUserRole', response.data.role_id);

          var userEmail = localStorage.getItem('userEmail'); // Lakukan apa pun yang diperlukan dengan nilai email, misalnya tampilkan di konsol atau di dalam elemen HTML
