"use strict";
(self["webpackChunkDantobBuss_Application"] = self["webpackChunkDantobBuss_Application"] || []).push([["resources_js_src_views_dashboard_Dashboard_vue"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    // Mengambil role_id dari route
    this.role_id = this.$route.query.role;
    console.log('Role ID pada halaman dashboard:', this.role_id);
  }
});
...
var render = function () {
  ...
  return _c("div", [
    _c("p", [_vm._v("Role ID pada halaman dashboard: " + _vm._s(_vm.role_id))]),
  ])
}
var staticRenderFns = []
