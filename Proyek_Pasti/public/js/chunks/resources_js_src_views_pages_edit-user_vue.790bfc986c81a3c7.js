...
/* harmony default export */ __webpack_exports__["default"] = ({
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().put("http://localhost:8081/user/update/" + id, _this.user, {
                  headers: {
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default().get("http://localhost:8081/user/" + id, {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
