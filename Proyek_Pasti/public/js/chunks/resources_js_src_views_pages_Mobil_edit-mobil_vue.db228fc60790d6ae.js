...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_5___default().get("http://localhost:8081/supirs", {
      headers: {
    ...
    axios__WEBPACK_IMPORTED_MODULE_5___default().get("http://localhost:8085/lokets", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_5___default().get("http://localhost:8086/bus/" + id, {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
